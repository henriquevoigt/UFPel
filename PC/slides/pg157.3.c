/* Modifique o programa exemplo-48.c, de modo que ele permita também a impressão de
todos os dados de uma pessoa com Nome e Sobrenome. Sugestão: usar a função de
busca feita na questão 2. */
